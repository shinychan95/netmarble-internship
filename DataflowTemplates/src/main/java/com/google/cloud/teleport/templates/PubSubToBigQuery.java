...
public class PubSubToBigQuery {
  ...
  public interface Options extends PipelineOptions, JavascriptTextTransformerOptions {
    ...
    @Default.String("netmarble-2020-intern:data_engineer.singular_log_raw_test")
    ValueProvider<String> getOutputTableSpec();

    void setOutputTableSpec(ValueProvider<String> value);

    @Description("Pub/Sub topic to read the input from")
    @Default.String("projects/netmarble-2020-intern/topics/singular-logs")
    ...
    @Default.String("netmarble-2020-intern:data_engineer.singular_log_raw_test_deadletter")
...
//                    .build());
  ...
  static class PubsubMessageToFailsafeElementFn
    ...
    public void processElement(ProcessContext context) {
      ...
      String messageJson = Base64.encodeBase64String(messageString.toByteArray());
